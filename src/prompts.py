PROMPTS = {
    ...
    "normal":
        lambda q: f"""Answer the following multiple-choice question.
Carefully read the context and all answer choices before making your decision.
Choose the option that is best supported by commonsense reasoning.
...
{q}""",
    ...
    "expert":
        lambda q: f"""You are recognized as a world-class expert in social reasoning, human behavior, and commonsense understanding.
