...
#SBATCH --array=0-5
#SBATCH --output=/users/sgssripa/models/logs/mc_t2_%a_%j.out
#SBATCH --error=/users/sgssripa/models/logs/mc_t2_%a_%j.err
...
python moralchoice_run.py $PROMPT_NAME 2
